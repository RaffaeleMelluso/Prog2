...
public class ArrayExt {
    ...
    // (accesso a vett: da 0 a size-1)
    private int size; //la parte effettivamente in uso del array,
    //all'inizio vale 0
    private int[] vett;
    ...
    /**
     * Se min>0, questo metodo costruisce un array di min elementi con
     * size=0. La lunghezza di vett sara' min*(una potenza di 2)
     */
    ...
    public void add(int i, int x) {
        ...
        assert size < vett.length; //controllo che ora lo spazio c'e'
